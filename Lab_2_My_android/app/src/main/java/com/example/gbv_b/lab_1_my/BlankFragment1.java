...
public class BlankFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final CheckBox checkBox1 = view.findViewById(R.id.checkBox);
        ...
        btn.setOnClickListener(v -> {
            if (checkBox1.isChecked() && !checkBox2.isChecked() && !checkBox3.isChecked()) {
                Toast.makeText(this.getActivity(), checkBox1.getText().toString(),
                        Toast.LENGTH_LONG).show();
            } else if (checkBox2.isChecked() && !checkBox1.isChecked() && !checkBox3.isChecked()) {
                Toast.makeText(this.getActivity(), checkBox2.getText().toString(),
                        Toast.LENGTH_LONG).show();
            } else if (checkBox3.isChecked() && !checkBox1.isChecked() && !checkBox2.isChecked()) {
                Toast.makeText(this.getActivity(), checkBox3.getText().toString(),
                        Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(this.getActivity(), "Error! please select only one variant.",
                        Toast.LENGTH_LONG).show();
            }
        });
        return view;
